...
/*    mkdir("output",0755);
    ...
    try {
        netw =
                std::make_shared<Network>(read_path/*inpvars.mapString["qasm"]std::string(argv[1]).c_str(),
    ...
    std::string contractmeth = "simple-stoch";//inpvars.mapString["contractmethod"];
